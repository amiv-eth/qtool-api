...
class BudgetItem(db.Model):
	budgetitem_id = db.Column(db.String(4), nullable = False, primary_key=True)
...
class BudgetConfirmed(db.Model):
	budgetitem_id = db.Column(db.String(4), ForeignKey('budget_item.budgetitem_id'), nullable=False, primary_key=True)
	financial_year = db.Column(INTEGER(4), nullable = False)
